...
class IncludePortalWorlds(Toggle):
    ...
    display_name = "Include_Portal_Worlds"
...
class IncludeSecretDungeons(Toggle):
    ...
    display_name = "Include_Secret_Dungeons"
...
class IncludeDreamDungeons(Toggle):
    ...
    display_name = "Include_Dream_Dungeons"
...
class IncludeSuperSecrets(Toggle):
    ...
    display_name = "Include_Super_Secrets"
...
class RemoveDreamDungeonRestrictions(Toggle):
    """
...
class ID2Options(PerGameCommonOptions):
    ...
    remove_dream_dungeon_restrictions: RemoveDreamDungeonRestrictions
