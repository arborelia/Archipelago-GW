...
class LocationNames(str, Enum):
    ...
    # Signs
    sign_incomplete_1 = "Lonely Road Caves - Incomplete Sign"
    sign_incomplete_2 = "Fluffy Fields Caves - Incomplete Sign"
    sign_incomplete_3 = "Pepperpain Caves - Incomplete Sign"
    sign_incomplete_4 = "Sweetwater Coast Caves - Incomplete Sign"
    sign_fcc_cipher = "Frozen Court Caves - Cipher Sign"
    sign_mos_hint = "Maze of Steel - Hint Sign"
    sign_mos_cipher = "Maze of Steel - Cipher Sign"
    sign_nowhere_hint_left = "Nowhere - Left Hint Sign"
    sign_nowhere_hint_right = "Nowhere - Right Hint Sign"
    sign_nowhere_cipher = "Nowhere - Cipher Sign"
    sign_ludo_city_cipher = "Ludo City - Cipher Sign"
    sign_abyss_shard_hint = "Abyssal Plane - Shard Hint Sign"
    sign_abyss_roll_hint = "Abyssal Plane - Roll Hint Sign"
    sign_abyss_drop_hint = "Abyssal Plane - Drop Table Hint Sign"
    sign_abyss_boss_hint = "Abyssal Plane - Boss Hint Sign"
    sign_place_cipher = "Place From Younger Days - Cipher Sign"
    sign_ffc_cipher = "Fluffy Fields Caves - Cipher Sign"
    sign_pr_e_cipher = "Promised Remedy - E Cipher Sign"
    sign_pr_f_cipher = "Promised Remedy - F Cipher Sign"
    sign_pr_g_left_cipher = "Promised Remedy - G Left Cipher Sign"
    sign_pr_g_middle_cipher = "Promised Remedy - G Middle Cipher Sign"
    ...
    di_1f_fire = "Bottomless Tower First Floor Green Fire Obtained"
    di_2f_fire = "Bottomless Tower Second Floor Green Fire Obtained"
    di_3f_fire = "Bottomless Tower Third Floor Green Fire Obtained"
    da_nw_crystal = "Quietus Northwest Crystal"
    da_ne_crystal = "Quietus Northeast Crystal"
    da_sw_crystal = "Quietus Southwest Crystal"
    da_se_crystal = "Quietus Southeast Crystal"
    da_center_crystal = "Quietus Central Crystal"
