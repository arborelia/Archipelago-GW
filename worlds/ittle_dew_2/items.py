...
item_table: Dict[str, ID2ItemData] = {
    ...
    iname.scroll_cave.value: ID2ItemData(ItemClassification.filler, 1, 18, "Bonus Items"),
    iname.scroll_portal.value: ID2ItemData(ItemClassification.filler, 1, 19, "Bonus Items"),
    iname.heart_yellow.value: ID2ItemData(ItemClassification.filler, 1, 20, "Bonus Items"),
    ...
    # iname.outfit_jenny.value: ID2ItemData(ItemClassification.filler, 1, 54, "Outfits"),
    # iname.outfit_swimsuit.value: ID2ItemData(ItemClassification.filler, 1, 55, "Outfits"),
    # iname.outfit_tippsie.value: ID2ItemData(ItemClassification.filler, 1, 56, "Outfits"),
    # iname.outfit_dude.value: ID2ItemData(ItemClassification.filler, 1, 57, "Outfits"),
    # iname.outfit_tiger.value: ID2ItemData(ItemClassification.filler, 1, 58, "Outfits"),
    # iname.outfit_id.value: ID2ItemData(ItemClassification.filler, 1, 59, "Outfits"),
    # iname.outfit_delinquint.value: ID2ItemData(ItemClassification.filler, 1, 60, "Outfits"),
    # iname.outfit_berry.value: ID2ItemData(ItemClassification.filler, 1, 61, "Outfits"),
    # iname.outfit_apa.value: ID2ItemData(ItemClassification.filler, 1, 62, "Outfits"),
    # iname.outfit_that_guy.value: ID2ItemData(ItemClassification.filler, 1, 63, "Outfits"),
    # iname.loot.value: ID2ItemData(ItemClassification.filler, 1 , 64, "Major Items"),
