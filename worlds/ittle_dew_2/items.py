...
item_table: Dict[iname, ID2ItemData] = {
    # set these back to 3
    ...
    # iname.shard: ID2ItemData(ItemClassification.progression | ItemClassification.useful, 36, 14, "Collectables"),
    ...
    iname.scroll_cave: ID2ItemData(ItemClassification.filler, 1, 18, "Bonus Items"),
    iname.scroll_portal: ID2ItemData(ItemClassification.filler, 1, 19, "Bonus Items"),
    iname.heart_yellow: ID2ItemData(ItemClassification.filler, 1, 20, "Bonus Items"),
    ...
    iname.d2_keyring: ID2ItemData(ItemClassification.progression, 0, 25, "Key Rings"),
    # iname.d3_key: ID2ItemData(ItemClassification.progression, 0, 26, "Keys"),
    # iname.d3_keyring: ID2ItemData(ItemClassification.progression, 0, 27, "Key Rings"),
    # iname.d4_key: ID2ItemData(ItemClassification.progression, 0, 28, "Keys"),
    # iname.d4_keyring: ID2ItemData(ItemClassification.progression, 0, 29, "Key Rings"),
    # iname.d5_key: ID2ItemData(ItemClassification.progression, 0, 30, "Keys"),
    # iname.d5_keyring: ID2ItemData(ItemClassification.progression, 0, 31, "Key Rings"),
    # iname.d6_key: ID2ItemData(ItemClassification.progression, 0, 32, "Keys"),
    # iname.d6_keyring: ID2ItemData(ItemClassification.progression, 0, 33, "Key Rings"),
    # iname.d7_key: ID2ItemData(ItemClassification.progression, 0, 34, "Keys"),
    # iname.d7_keyring: ID2ItemData(ItemClassification.progression, 0, 35, "Key Rings"),
    # iname.d8_key: ID2ItemData(ItemClassification.progression, 0, 36, "Keys"),
    # iname.d8_keyring: ID2ItemData(ItemClassification.progression, 0, 37, "Key Rings"),
    # iname.s1_key: ID2ItemData(ItemClassification.progression, 0, 38, "Keys"),
    # iname.s1_keyring: ID2ItemData(ItemClassification.progression, 0, 39, "Key Rings"),
    # iname.s2_key: ID2ItemData(ItemClassification.progression, 0, 40, "Keys"),
    # iname.s2_keyring: ID2ItemData(ItemClassification.progression, 0, 41, "Key Rings"),
    # iname.s3_key: ID2ItemData(ItemClassification.progression, 0, 42, "Keys"),
    # iname.s3_keyring: ID2ItemData(ItemClassification.progression, 0, 43, "Key Rings"),
    # iname.s4_key: ID2ItemData(ItemClassification.progression, 0, 44, "Keys"),
    # iname.s4_keyring: ID2ItemData(ItemClassification.progression, 0, 45, "Key Rings"),
    # iname.dd_key: ID2ItemData(ItemClassification.progression, 0, 46, "Keys"),
    # iname.dd_keyring: ID2ItemData(ItemClassification.progression, 0, 47, "Key Rings"),
    # iname.di_key: ID2ItemData(ItemClassification.progression, 0, 48, "Keys"),
    # iname.di_keyring: ID2ItemData(ItemClassification.progression, 0, 49, "Key Rings"),
    # iname.dfc_key: ID2ItemData(ItemClassification.progression, 0, 50, "Keys"),
    # iname.dfc_keyring: ID2ItemData(ItemClassification.progression, 0, 51, "Key Rings"),
    # iname.da_key: ID2ItemData(ItemClassification.progression, 0, 52, "Keys"),
    # iname.da_keyring: ID2ItemData(ItemClassification.progression, 0, 53, "Key Rings"),
