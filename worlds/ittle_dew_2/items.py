...
item_table: Dict[str, ID2ItemData] = {
    ...
    iname.card_safety.value: ID2ItemData(ItemClassification.useful, 1, 102, "Cards"),
    iname.card_shellbun.value: ID2ItemData(ItemClassification.useful, 1, 103, "Cards"),
    iname.card_spikebun.value: ID2ItemData(ItemClassification.useful, 1, 104, "Cards"),
    iname.card_gate.value: ID2ItemData(ItemClassification.useful, 1, 105, "Cards"),
    iname.card_snake.value: ID2ItemData(ItemClassification.useful, 1, 106, "Cards"),
    iname.card_mimic.value: ID2ItemData(ItemClassification.useful, 1, 107, "Cards"),
    iname.card_ogler.value: ID2ItemData(ItemClassification.useful, 1, 108, "Cards"),
    iname.card_hyperdusa.value: ID2ItemData(ItemClassification.useful, 1, 109, "Cards"),
    iname.card_easel.value: ID2ItemData(ItemClassification.useful, 1, 110, "Cards"),
    iname.card_warnip.value: ID2ItemData(ItemClassification.useful, 1, 111, "Cards"),
    iname.card_octacle.value: ID2ItemData(ItemClassification.useful, 1, 112, "Cards"),
    iname.card_rotnip.value: ID2ItemData(ItemClassification.useful, 1, 113, "Cards"),
    iname.card_bees.value: ID2ItemData(ItemClassification.useful, 1, 114, "Cards"),
    iname.card_volcano.value: ID2ItemData(ItemClassification.useful, 1, 115, "Cards"),
    iname.card_shark.value: ID2ItemData(ItemClassification.useful, 1, 116, "Cards"),
    iname.card_swimmy.value: ID2ItemData(ItemClassification.useful, 1, 117, "Cards"),
    iname.card_bunboy.value: ID2ItemData(ItemClassification.useful, 1, 118, "Cards"),
    iname.card_spectre.value: ID2ItemData(ItemClassification.useful, 1, 119, "Cards"),
    iname.card_brutus.value: ID2ItemData(ItemClassification.useful, 1, 120, "Cards"),
    iname.card_jelly.value: ID2ItemData(ItemClassification.useful, 1, 121, "Cards"),
    iname.card_skullnip.value: ID2ItemData(ItemClassification.useful, 1, 122, "Cards"),
    iname.card_slayer.value: ID2ItemData(ItemClassification.useful, 1, 123, "Cards"),
    iname.card_titan.value: ID2ItemData(ItemClassification.useful, 1, 124, "Cards"),
    iname.card_chilly.value: ID2ItemData(ItemClassification.useful, 1, 125, "Cards"),
    iname.card_flower.value: ID2ItemData(ItemClassification.useful, 1, 126, "Cards"),
    iname.card_hexrot.value: ID2ItemData(ItemClassification.useful, 1, 127, "Cards"),
    iname.card_mole.value: ID2ItemData(ItemClassification.useful, 1, 128, "Cards"),
    iname.card_bun.value: ID2ItemData(ItemClassification.useful, 1, 129, "Cards"),
    iname.card_cat.value: ID2ItemData(ItemClassification.useful, 1, 130, "Cards"),
    iname.card_mermaid.value: ID2ItemData(ItemClassification.useful, 1, 131, "Cards"),
    iname.card_berry.value: ID2ItemData(ItemClassification.useful, 1, 132, "Cards"),
    iname.card_mapman.value: ID2ItemData(ItemClassification.useful, 1, 133, "Cards"),
    iname.card_cyber.value: ID2ItemData(ItemClassification.useful, 1, 134, "Cards"),
    iname.card_biadlo.value: ID2ItemData(ItemClassification.useful, 1, 135, "Cards"),
    iname.card_lenny.value: ID2ItemData(ItemClassification.useful, 1, 136, "Cards"),
